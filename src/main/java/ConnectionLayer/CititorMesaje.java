                ...
                if(chr=='\n'){
                    ...
                    SwingUtilities.invokeLater(new Runnable() {
                        public void run(){
                            ...
                            {
                                String intrebare=text.substring(3, text.length()-2);
                                //conexiune.getFereastra().setIntrebare(intrebare);
                                conexiune.controller.setIntrebare(intrebare);
                            ...
                            else if(text.length()>2 && text.charAt(0)=='(' && text.charAt(text.length()-1)==')')
                            {
                                ...
                                conexiune.controller.setButoaneRaspuns(text);
                            ...
                            if(text.length()>2 && text.charAt(0)=='s'&& text.charAt(1)=='(' && text.charAt(text.length()-1)==')')
                            {
                                ...
                                conexiune.controller.pushEcranSolutie(solutie);
